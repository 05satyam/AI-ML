...
### 🔍 LLM Observability
- [LlamaTrace - LLM Observability](https://github.com/05satyam/AI-ML/blob/main/topcis_and_handson/llm-observability/LlamaTrace_(Hosted_Arize_Phoenix).ipynb)
...
- [Agentic RAG Talk (AV + WeCloud)](https://github.com/05satyam/AI-ML/blob/main/demo_applications/Talk_On_Naive_RAG_and_Agentic_RAG_and_LLM_Observability.ipynb)
